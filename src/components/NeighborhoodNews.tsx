...
export function NeighborhoodNews({ onNewsChange }: Props) {
  ...
  return (
    <section
      ...
      className="flex min-h-[19rem] flex-1 flex-col gap-1 overflow-hidden rounded-xl border border-gold/30 bg-[rgba(8,8,12,0.88)] px-2 py-1 sm:min-h-[20.5rem]"
    >
      ...
      <div data-news-body className="flex min-h-0 flex-1 flex-col gap-1.5 overflow-y-auto">
        {status === "ready" && items.length > 0 ? (
          <ul className="flex min-h-[13rem] flex-1 flex-col gap-1">
          ...
          <>
            <div className="min-h-[13rem] flex-1" aria-hidden />
