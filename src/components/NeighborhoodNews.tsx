...
export function NeighborhoodNews({ onNewsChange }: Props) {
  ...
  return (
    <section
      ...
      className="mt-[var(--home-stack-gap)] flex min-h-[18.5rem] flex-1 flex-col gap-1 overflow-hidden rounded-xl border border-gold/30 bg-[rgba(8,8,12,0.88)] px-2 py-1 sm:min-h-[20rem]"
    >
      ...
      <div data-news-body className="flex min-h-0 flex-1 flex-col gap-1.5 overflow-hidden">
        ...
        >
          {status === "ready" && items.length > 0 ? (
            <ul data-news-list className="flex min-h-[10rem] flex-1 flex-col gap-1">
            ...
            <>
              <div data-news-spacer className="min-h-[10rem] flex-1" aria-hidden />
