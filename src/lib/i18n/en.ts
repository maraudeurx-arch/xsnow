...
export const en: Messages = {
  ...
  guide: {
    ...
    replay: "Listen again",
    offerShortcuts: "Shortcuts to Earn now, Your ideas, My profile, and Share",
    vosIdees: "Your ideas",
    partager: "Share",
  ...
  register: {
    ...
    nudgeHint: "Then invite a neighbour — the link does not include your email or phone.",
    inviteCta: "Invite a neighbour",
    share: "Share",
