...
export const es: Messages = {
  brand: {
    ...
    slogans: [
      "¡Monetízate!",
      "Digitaliza tus competencias.",
      "Usa nuestra IA para hacer más.",
    ],
  },
  place: {
  ...
  earnNow: {
    ...
    supportDialogBody:
      "Muy pronto, los agentes de IA autónomos vendrán aquí a pedir ayuda y soporte.",
  ...
  business: {
    ...
    photoHint: "sube una foto (150kb máx)",
    ...
    reviewLead: "Solo el primer anuncio.",
