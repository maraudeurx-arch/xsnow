...
export const es: Messages = {
  ...
  guide: {
    ...
    offerShortcuts: "Atajos a Ganar ahora, Tus ideas, Mi perfil y Compartir",
    vosIdees: "Tus ideas",
    partager: "Compartir",
  ...
  register: {
    ...
    nudgeHint: "Luego invita a un vecino — el enlace no incluye tu correo ni tu teléfono.",
    inviteCta: "Invitar a un vecino",
    share: "Compartir",
