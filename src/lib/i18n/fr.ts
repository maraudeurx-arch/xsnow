export const fr = {
  ...
  guide: {
    ...
    replay: "Réécouter",
    offerShortcuts: "Raccourcis Gagner maintenant, Vos idées, Mon profil et Partager",
    vosIdees: "Vos idées",
    partager: "Partager",
  ...
  register: {
    ...
    nudgeHint: "Ensuite, invite un voisin — le lien ne contient pas ton e-mail ni ton téléphone.",
    inviteCta: "Inviter un voisin",
    share: "Partager",
