...
describe("install tip copy", () => {
  it("keeps iOS home-screen steps in FR/EN/ES", () => {
    ...
    assert.match(fr.install.iphoneSteps[0]!, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    assert.match(en.install.iphoneSteps[0]!, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    assert.match(es.install.iphoneSteps[0]!, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    ...
    assert.match(fr.install.profileLead, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    assert.match(en.install.profileLead, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    assert.match(es.install.profileLead, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    assert.match(fr.install.tip, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    assert.match(fr.install.wrongShortcut, /There isn’t a GitHub Pages site here/);
    assert.match(fr.install.wrongShortcut, /\/xsnow\//);
    ...
    assert.match(fr.notFound.githubPagesHint, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    assert.match(en.notFound.githubPagesHint, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
    assert.match(es.notFound.githubPagesHint, /https:\/\/maraudeurx-arch\.github\.io\/xsnow\//);
