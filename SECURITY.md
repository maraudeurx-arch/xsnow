...
Public summary in the app (FR / EN / ES): [Sécurité](https://maraudeurx-arch.github.io/xsnow/securite/). Responsible disclosure today: [GitHub Issues](https://github.com/maraudeurx-arch/xsnow/issues). There is **no independent third-party audit yet**.
